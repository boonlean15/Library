						...
						<c:if test="${not empty reader }">
							...
							<li class="dropdown"><a href="#" role="button"
								class="dropdown-toggle" data-hover="dropdown"> <i
									class="glyphicon glyphicon-user"></i> 欢迎您，${reader.name }<i
									class="caret"></i></a>
								<ul class="dropdown-menu">
									...
									<li role="presentation" class="divider"></li>
									<li><a
										href="${pageContext.request.contextPath}/reader?method=logout">退出</a></li>
								</ul></li>
						</c:if>
		...
		<div class="row">
			...
			<div class="col-md-2 bootstrap-admin-col-left">
				<ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					<li class="active"><a
						href="${pageContext.request.contextPath}/bookreader?method=findBookByPage&pageCode=1"><i
						...
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal"
									action="${pageContext.request.contextPath}/bookreader?method=queryBook&pageCode=1"
									method="post">
									...
									<div class="col-lg-5 form-group">
										...
										<div class="col-lg-8">
											<select class="form-control" id="bookTypeId"
												name="bookTypeId" onclick="getAllBookTypes()">
									...
									<tbody>
										...
										<td>
											<button type="button" class="btn btn-info btn-xs"
												...
												onclick="getBookInfo(${book.bookId})">查看</button>
										</td>
									</tbody>
								</c:forEach>
							</c:if>
						...
						<c:if test="${not empty pb }">
							...
							<div class="pull-right">
								...
								<ul class="pagination">
									...
									<li><a
										href="${pageContext.request.contextPath}/bookreader?method=${pb.url }pageCode=1">首页</a></li>
									<li><a
										href="${pageContext.request.contextPath}/bookreader?method=${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a></li>
									<!-- 上一页 -->
									<%-- 循环显示页码列表 --%>
									<c:forEach begin="${begin }" end="${end }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="${pageContext.request.contextPath}/bookreader?method=${pb.url }pageCode=${i}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${pb.pageCode < pb.totaPage }">
										<li><a
											href="${pageContext.request.contextPath}/bookreader?method=${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a></li>
									</c:if>
									<%--否则显示尾页 --%>
									<li><a
										href="${pageContext.request.contextPath}/bookreader?method=${pb.url }pageCode=${pb.totaPage}">尾页</a></li>
								</ul>
							</div>
						</c:if>
					</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="name"
									placeholder="请输入您的真实姓名" value="${reader.name }"> <label
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="phone"
									placeholder="请输入您的联系号码" value="${reader.phone }"> <label
						...
						<div class="form-group">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control" id="email"
									placeholder="请输入您的邮箱" value="${reader.email }"> <label
