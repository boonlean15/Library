					...
					<ul class="nav navbar-nav navbar-right">
						<li class="dropdown"><a href="#" role="button"
							class="dropdown-toggle" data-hover="dropdown"> <i
								class="glyphicon glyphicon-user"></i> 欢迎您， ${admin.name } <i
								class="caret"></i></a>
							...
							<ul class="dropdown-menu">
								...
								<li><a
									href="${pageContext.request.contextPath}/admin?method=logout">退出</a></li>
							</ul></li>
					</ul>
				</div>
			</div>
						...
						<div class="panel panel-default bootstrap-admin-no-table-panel">
							...
							<div
								...
								<form class="form-horizontal"
									action="${pageContext.request.contextPath}/forfeitManage?method=queryForfeitInfo&pageCode=1"
									method="post">
									<div class="row">
										<div class="col-lg-5 form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" name="borrowId" type="text"
													value="" placeholder="请输入借阅编号"> <label
													class="control-label" for="borrow_sno"
										...
										<div class="col-lg-5 form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" name="paperNO" type="text"
													value="" placeholder="请输入读者证件号"> <label
													class="control-label" for="borrow_sno"
													style="display: none"></label>
											</div>
										</div>
										<div class="col-lg-5 form-group">
											...
											<div class="col-lg-8">
												<input class="form-control" name="ISBN" type="text" value=""
													placeholder="请输入借阅图书的ISBN号"> <label
													class="control-label" for="borrow_bno"
													style="display: none"></label>
											</div>
										</div>
									...
									<tbody>
										...
										<td>
											<button type="button" class="btn btn-info btn-xs"
												data-toggle="modal" data-target="#findBackModal"
												onclick="getForfeitInfoById(${forfeit.borrowId})">查看</button>
											<button type="button" class="btn btn-success btn-xs"
												onclick="pay(${forfeit.borrowId})">付款</button>
										</td>
									</tbody>
								</c:forEach>
                            </c:if>
						 ...
						 <c:if test="${not empty pb }">
							...
							<div class="pull-right">
								...
								<ul class="pagination">
									...
									<li><a
										href="${pageContext.request.contextPath}/forfeitManage?method=${pb.url }pageCode=1">首页</a></li>
									<li><a
										href="${pageContext.request.contextPath}/forfeitManage?method=${pb.url }pageCode=${pb.pageCode-1 }">&laquo;</a></li>
									<!-- 上一页 -->
									<%-- 循环显示页码列表 --%>
									<c:forEach begin="${begin }" end="${end }" var="i">
										<c:choose>
											...
											<c:otherwise>
												<li><a
													href="${pageContext.request.contextPath}/forfeitManage?method=${pb.url }pageCode=${i}">${i}</a></li>
											</c:otherwise>
										</c:choose>
									</c:forEach>
									...
									<c:if test="${pb.pageCode < pb.totaPage }">
										<li><a
											href="${pageContext.request.contextPath}/forfeitManage?method=${pb.url }pageCode=${pb.pageCode+1}">&raquo;</a></li>
									</c:if>
									<%--否则显示尾页 --%>
									<li><a
										href="${pageContext.request.contextPath}/forfeitManage?method=${pb.url }pageCode=${pb.totaPage}">尾页</a></li>
								</ul>
							</div>
						</c:if>
					</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">查看罚款信息</h4>
					</div>
