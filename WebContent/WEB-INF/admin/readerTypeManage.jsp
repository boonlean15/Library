                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                            <c:if test="${not empty readertypes}">
                            <c:forEach items="${readertypes }" var="readerType">
                             <tbody>
	                                ...
	                                <td>
	                                	<button type="button" class="btn btn-warning btn-xs" data-toggle="modal" data-target="#updateModal" onclick="updateReaderType('${readerType.readerTypeId}')">修改</button>
	                               	</td>                                              
                          	  </tbody>
                            </c:forEach>
                            </c:if>
